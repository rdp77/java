...
//                      else "   TEKAN SEMBARANG GAN UNTUK MULAI!,DAN P UNTUK PAUSE"
//
//        fill: Color.BLACK
//      }
//    ]
...
//  }
  ...
  public Maze() {
    ...
    final Ghost ghostBlinky = new Ghost(
            new Image(getClass().getResourceAsStream("images/ghostblue1.png")),
            new Image(getClass().getResourceAsStream("images/ghostblue2.png")),
            this,
            pacMan,
            15, // x
            14, // y
...
//    defaultImage1: Image {
//      url: "{__DIR__}images/ghostblue1.png"
//    }
//
//    defaultImage2: Image {
//      url: "{__DIR__}images/ghostblue2.png"
//    }
//
//     maze: this
//     pacMan: pacMan
...
//    };
    ...
    final Ghost ghostPinky = new Ghost(
            new Image(getClass().getResourceAsStream("images/ghostgreen1.png")),
            new Image(getClass().getResourceAsStream("images/ghostgreen2.png")),
            this,
            pacMan,
            14,
            15,
...
//     defaultImage1:Image {
//        url: "{__DIR__}images/ghostgreen1.png"
//     }
//
//     defaultImage2:Image {
//       url: "{__DIR__}images/ghostgreen2.png"
//     }
//
//     maze: this
//     pacMan: pacMan
...
//  ];
    ...
    final StringBinding messageBinding = new StringBinding() {
            ...
            protected String computeValue() {
                if (gamePaused.get()) {
                    return "PENCET 'P' GAN UNTUK LANJUTIN";
                } else {
                    return "LU HARUS PENCET UNTUK MULAI";
                }
            }
        };
