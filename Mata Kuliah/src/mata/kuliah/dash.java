...
public class dash extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        double presensi,tugas,quiz,uts,uas,total;
        
        presensi=Double.valueOf(jTextField1.getText());  
        tugas=Double.valueOf(jTextField2.getText());  
        quiz=Double.valueOf(jTextField3.getText());  
        uas=Double.valueOf(jTextField4.getText());  
        uts=Double.valueOf(jTextField5.getText());  
        total=(0.1*presensi)+(0.1*tugas)+(0.1*tugas)+(0.3*uts)+(0.4*uas);
